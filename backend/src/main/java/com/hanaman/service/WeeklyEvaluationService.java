...
public class WeeklyEvaluationService {
    ...
    private static final int SUCCESS_DAYS_THRESHOLD = 5;
    private static final int WEEKS_PER_CYCLE = 4;
    ...
    private void finalizeCycle(UserExercise activeExercise) {
        ...
        if (successWeeks >= MASTER_REQUIRED_SUCCESS_WEEKS) {
            ...
            activeExercise.setCycleStartDate(LocalDate.now());
